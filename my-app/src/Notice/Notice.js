...
const Notice = () => {
    return (
        ...
        >
            ...
            <p>
                Conformément aux <a href="http://www.black-book-editions.fr/texte.php?id=6"> conditions d’utilisation décrites sur le site de Black Book Editions</a>.
                <br />
                Ce site utilise des marques déposées et/ou des droits d’auteurs qui sont la propriété de Black Book Editions comme l’y autorisent les conditions d’utilisation de Black Book Editions. Ce site n’est pas publié par Black Book Editions et n’a pas reçu son aval ni une quelconque approbation de sa part. Pour de plus amples informations sur Black Book Editions, consultez <a href="www.black-book-editions.fr">www.black-book-editions.fr</a>.
            </p>
            <br />
            <h2>
                Droits d'auteurs concernant les illustrations
            </h2>
            <p>
                Toutes les images de ce site ont été générées à l'aide de la plateforme Midjourney et sont la propriété de Nicolas Bédé. Nous avons obtenu les droits d'utilisation de ces images en conformité avec les conditions d'utilisation de Midjourney. Toute reproduction, représentation, diffusion ou utilisation, même partielle, de ces images sans autorisation écrite est strictement interdite et pourra faire l'objet de poursuites judiciaires conformément aux lois et réglementations en vigueur en matière de propriété intellectuelle.
            </p>
            <h2>
                Open Game License
            </h2>
            ...
            Chroniques Oubliées™ DRS. Auteurs : Benjamin Lupu, Benjamin « xben » Thibault,  Freddy Martinez, Nicolas Bédé, Jocelyn Blanc.
        </motion.div>
    );
};
