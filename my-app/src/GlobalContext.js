...
const GlobalProvider = (props) => {
  ...
  const [primaryStats, setPrimaryStats] = useState({ STR: 0, DEX: 0, CON: 0, INT: 0, WIS: 0, CHA: 0 });
  const [secondaryStats, setSecondaryStats] = useState({ HP: 8, INIT: 0, AC: 0, ranged: 0, melee: 0, magic: 0 });
  ...
  const [raceBonus, setRaceBonus] = useState({STR: 0, DEX: 0, CON: 0, INT: 0, WIS: 0, CHA: 0, HP: 8, INIT: 0, AC: 0, ranged: 0, melee: 0, magic: 0});
  const [classBonus, setClassBonus] = useState({STR: 0, DEX: 0, CON: 0, INT: 0, WIS: 0, CHA: 0, HP: 8, INIT: 0, AC: 0, ranged: 0, melee: 0, magic: 0});
